...
router.post("/update_pur_sale/:inv_no", AuthController.protectGlobal, pur_saleController.update_pur_sale);
router.post("/pur_sale_trans", AuthController.protectGlobal, pur_saleController.pur_sale_trans);
router.get("/pur_sale_trans/:transentryId", AuthController.protectGlobal, pur_saleController.get_pur_sale_trans);
router.get("/pur_saleEntry", AuthController.protectGlobal, pur_saleController.get_pur_saleEntry);
router.delete("/delete_pur_sale/:inv_no", AuthController.protectGlobal, pur_saleController.delete_pur_sale);
